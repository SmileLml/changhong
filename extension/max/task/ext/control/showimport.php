...
class mytask extends task
{
    ...
    public function showImport($executionID, $pagerID = 1, $insert = '')
    {
        ...
        $this->config->task->dtable->fieldList['story']['dataSource']  = array('module' => 'story', 'method' => 'getExecutionStoryPairs', 'params' => ['executionID' => '$executionID', 'productID' => 0, 'branch' => 'all', 'moduleIdList' => '', 'type' => '', 'status' => 'active', 'storyType' => 'story', 'hasParent' => false]);
