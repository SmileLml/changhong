            ...
            (
                ...
                (
                    ...
                    (
                        ...
                        set::useHtml(true),
                        tableData(item(set::name($lang->testreport->startEnd), $report->begin . ' ~ ' . $report->end), item(set::name($lang->testreport->owner), zget($users, $report->owner)), item(set::name($lang->testreport->members), $members), !empty($execution->desc) ? item
                        (
