...
{
    toolBar(hasPriv('repo', 'createRepo') && $serverPairs ? item(set($createRepoItem + array
    (
        'icon'  => 'plus',
        'class' => 'btn primary'
    ))) : null);
...
else
{
    ...
    (
        'icon'  => 'plus',
        'class' => 'btn primary'
    ))) : null, !hasPriv('repo', 'create') && hasPriv('repo', 'import') && $serverPairs ? item(set($batchCreateItem + array
    (
        'icon'  => 'plus',
        'class' => 'btn primary'
    ))) : null, !hasPriv('repo', 'import') && hasPriv('repo', 'create') ? item(set($createItem + array
    (
        'icon'  => 'plus',
        'class' => 'btn primary'
    ))) : null, hasPriv('repo', 'import') && hasPriv('repo', 'create') ? btnGroup
    (
