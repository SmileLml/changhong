...
class productModel extends model
{
     ...
     * @return array
     */
    public function getListByAcl($acl)
    {
     ...
     * @return array
     */
    public function getProductPairsByProject($projectID = 0, $status = 'all', $append = '', $noDeleted = true, $noShadow = false)
    {
     ...
     * @return array
     */
    public function getPairsByProjectModel($model = 'all')
    {
     ...
     * @return int[]
     */
    public function getProducts($projectID = 0, $status = 'all', $orderBy = '', $withBranch = true, $append = '', $noDeleted = true, $noShadow = false)
    {
        /* 如果是新手教程模式，直接返回测试数据。*/
     ...
     * @return array
     */
    public function concatProductLine($products)
    {
     ...
     * @return array
     */
    public function getProductsGroupByProgram()
    {
     ...
     * @return int|false
     */
    public function create($product, $lineName = '')
    {
     ...
     * @return array|false
     */
    public function close($productID, $product, $comment = '')
    {
     ...
     * @return array|false
     */
    public function activate($productID, $product, $comment = '')
    {
        $oldProduct = $this->getByID($productID);
        if(empty($product)) return false;
     ...
     * @return void
     */
    public function updateOrder($sortedIdList)
    {
        /* Remove programID. */
     ...
     * @return array
     */
    public function manageLine($lines)
    {
     ...
     * @return void
     */
    public function buildSearchForm($productID, $products, $queryID, $actionURL, $storyType = 'story', $branch = '', $projectID = 0)
    {
     ...
     * @return array
     */
    public function getProjectPairsByProductIdList($productIdList)
    {
     ...
     * @return array
     */
    public function getProjectPairsByProduct($productID, $branch = '0', $appendProject = '', $status = '', $param = '')
    {
     ...
     * @return array
     */
    public function getProjectListByProduct($productID, $browseType = 'all', $branch = '0', $involved = false, $orderBy = 'order_desc', $pager = null)
    {
     ...
     * @return int[]
     */
    public function getProjectStatsByProduct($productID, $browseType = 'all', $branch = '0', $involved = false, $orderBy = 'order_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getExecutionPairsByProduct($productID, $branch = '', $projectID = 0, $mode = '', $unAllowedStage = array())
    {
     ...
     * @return array
     */
    public function getStats4Kanban($browseType = 'my')
    {
        /* Get base data. */
     ...
     * @return string[]
     */
    public function getLinePairs($programIdList = 0, $filterRoot = false)
    {
     ...
     * @return object[]
     */
    public function getLines($programIdList = array())
    {
     ...
     * @return int
     */
    public function checkAccess($productID, $products)
    {
     ...
     * @return int
     */
    protected function getAccessibleProductID($productID, $products)
    {
        if(empty($productID))
        {
     ...
     * @return bool
     */
    protected function deleteByID($productID)
    {
     ...
     * @return object
     */
    public function formatDataForList($product, $users)
    {
     ...
     * @return array
     */
    public function buildRoadmapForUI($roadmaps, $branchKey = 0)
    {
     ...
     * @return array
     */
    protected function getList($programID = 0, $status = 'all', $limit = 0, $line = 0, $shadow = 0, $fields = '*')
    {
     ...
     * @return array
     */
    public function getStatsProducts($productIdList, $appendProgram, $orderBy, $pager = null)
    {
     ...
     * @return array[]
     */
    public function getStatsStoriesAndRequirements($productIdList, $storyType)
    {
     ...
     * @return array
     */
    public function getCaseCoveragePairs($productIdList)
    {
        if(empty($productIdList)) return array();
     ...
     * @return object[]
     */
    public function getStoryStatusCountByID($productID, $storyType = 'story')
    {
     ...
     * @return [array, bool]
     */
    public function getGroupRoadmapData($productID, $branch, $count)
    {
        $roadmap = array();
        $return  = false;
     ...
     */
    public function getRoadmapOfReleases($roadmap, $releases, $branch, $count)
    {
        $total           = 0;
        $return          = false;
        $today           = helper::today();
     ...
     * @return [array, int, bool]
     */
    public function getRoadmapOfPlans($orderedPlans, $parents, $branch, $count)
    {
        $return  = false;
        $total   = 0;
        $roadmap = array();
    ...
    public function getProductLink($module, $method, $extra = '', $branch = false)
    {
        ...
        if(in_array($module, array('story', 'epic', 'requirement')) && in_array($method, array('create', 'edit', 'batchcreate', 'view'))) return helper::createLink('product', 'browse', "productID=%s&branch={$branchID}&browseType=" . ($this->config->vision == 'or' ? 'assignedtome' : 'unclosed') . "&param=0&storyType=$module");
        ...
        {
            $projectID = $extra;
            if(strpos($extra, 'projectID') !== false)
            {
     ...
     * @return array
     */
    public function buildSearchConfig($productID, $storyType)
    {
        $searchConfig = $this->config->product->search;
