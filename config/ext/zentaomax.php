...
if($config->edition == 'max' || $config->edition == 'ipd')
{
    ...
    $devopsKey = array_search('devops', $config->featureGroup->other);
    if($devopsKey !== false) array_splice($config->featureGroup->other, $devopsKey + 1, 0, 'deliverable');
}
