...
class upgradeModel extends model
{
     ...
     * @param string $fromVersion
     */
    public function executeOthers($fromEdition, $fromVersion)
    {
     ...
     * @return void
     */
    public function executeByConfig($version)
    {
     ...
     * @return int
     */
    public function createProgram($projectIdList = array())
    {
     ...
     */
    public function createNewProgram($data, $projectIdList)
    {
     ...
     * @return bool|int
     */
    public function createNewLine($lineName, $programID)
    {
        /* Insert product line. */
     ...
     * @return bool|int|array
     */
    public function createNewProject($data, $programID, $projectIdList)
    {
     ...
     * @return void
     */
    public function computeProductAcl($productIdList = array(), $programID = 0, $lineID = null)
    {
        /* Compute product acl. */
     ...
     * @return void
     */
    protected function updateProjectMembers()
    {
     ...
     * @return array
     */
    protected function getProjectTeams($projectIdList)
    {
     ...
     * @return void
     */
    public function mergeRepo($repoes, $products)
    {
    ...
    {
        $users = array_keys($this->dao->select('id')->from(TABLE_USER)->where('deleted')->eq('0')->fetchAll('id'));
     ...
     * @return int
     */
    public function getNoMergedProductCount()
    {
     ...
     * @return int
     */
    public function getNoMergedSprintCount()
    {
     ...
     * @return true
     */
    public function updateWorkflowFieldDefaultValue()
    {
     ...
     * @return bool
     */
    public function changeCustomStoryStage()
    {
     ...
     * @return bool
     */
    public function openCacheByAPCu()
    {
    ...
    public function addFeedbackDatasource()
    {
        ...
        $sql  = "CREATE OR REPLACE VIEW $view (`id`, `title`) AS $datasource->datasource";
     ...
     * @return bool
     */
    public function processDemandFiles()
    {
     ...
     * @return array
     */
    public function getUpgradeDocs()
    {
     ...
     * @return bool
     */
    public function upgradeDoc($docID, $version, $content)
    {
     ...
     * @return bool
     */
    public function upgradeWikis($wikis)
    {
    ...
    /**
     * 获取需要升级的文档模板。
     * Get doc templates need to upgrade.
     *
     * @access public
     * @return array
     */
    public function getUpgradeDocTemplates()
    {
     ...
     * @return bool
     */
    public function upgradeDocTemplate($docID, $version)
    {
        $docContent = $this->dao->select('*')->from(TABLE_DOCCONTENT)->where('doc')->eq($docID)->andWhere('version')->eq($version)->fetch();
        if(empty($docContent)) return false;
     ...
     * @return bool
     */
    public function upgradeWikiTemplates($wikis = array())
    {
     ...
     * @return string
     */
    public function convertWiki2Html($bookID = 0, $nodeID = 0, $showLink = false)
    {
     ...
     * @return array
     */
    public function getTemplateBlock($templateID)
    {
