...
JS;
     ...
     * @param mixed[] $relatedObjectInfo
     * @param string $relationName
     * @param string $relationType
     * @param string $browseType
     */
    protected function getObjectItem($relatedObjectID, $relatedObjectType, $relatedObjectInfo, $relationName, $relationType, $browseType)
    {
