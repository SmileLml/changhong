...
class commonModel extends model
{
   ...
   /**
     ...
     * @return array
     */
    public static function formConfig($module, $method, $objectID = 0)
    {
        global $config, $app;
     ...
     * @return array
     */
    public static function getMainNavList($moduleName, $useDefault = false)
    {
     ...
     * @return string
     */
    public static function getActiveMainMenu()
    {
        global $app;
...
eof;
     ...
     * @return bool
     */
    public static function getUserPriv($module, $method, $object = null, $vars = '')
    {
        global $app,$config;
        $module = strtolower($module);
        $method = strtolower($method);
     ...
     * @return void
     */
    public static function buildActionItem($module, $method, $params, $object = null, $attrs = array())
    {
     ...
     * @return array|bool
     */
    public function checkPrivForOperateAction($actionData, $action, $moduleName, $data, $menu)
    {
     ...
     * @return string
     */
    public static function printDuration($seconds, $format = 'y-m-d-h-i-s')
    {
        global $lang;
     ...
     * @return bool
     */
    public static function buildMoreButton($executionID, $printHtml = true)
    {
        global $lang, $app, $dao;
     ...
     * @return string
     */
    public static function printMainMenu($printHtml = true)
    {
        global $app, $lang, $config;
...
EOF;
     ...
     * @return mixed
     */
    public static function getDotStyle($showCount, $unreadCount)
    {
