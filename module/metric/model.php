...
class metricModel extends model
{
    ...
    */
     ...
     * @return array
     */
    protected function getMetricRecordDateField($metric)
    {
        $dataFields = array();
        $dateType   = $this->getDateTypeByCode($metric->code);
     ...
     * @return array|false
     */
    public function getRecordFields($code)
    {
        $metric   = $this->getByCode($code);
     ...
     * @return array
     */
    public function buildOperateMenu($metric)
    {
        $menuList = array
        (
            'main'   => array(),
     ...
     * @param mixed[] $cols
     */
    public function initActionBtn($metrics, $cols)
    {
        foreach($metrics as $metric)
        {
     ...
     * @return void
     */
    public function updateMetricFields($metricID, $metric)
    {
     ...
     * @return array
     */
    public function getEchartLegend($series, $range = 'time')
    {
     ...
     * @param mixed[] $header
     */
    public function getEchartsOptions($header, $data, $chartType = 'line')
    {
     ...
     */
    public function getObjectOptions($data, $type, $chartType)
    {
     ...
     * @param string $chartType
     */
    public function getTimeOptions($header, $data, $type, $chartType)
    {
     ...
     * @return array
     */
    public function genDataZoom($dataLength, $initZoom = 10, $axis = 'x')
    {
     ...
     * @param mixed[] $header
     */
    public function getPieEchartsOptions($header, $datas)
    {
        list($x, $y) = $this->getEchartXY($header);
     ...
     * @param string $dateType
     */
    public function getDateByDateType($dateType)
    {
     ...
     * @return string
     */
    public function getDefaultDate($dateLabels, $filters = array())
    {
        $defaultDate = '';
