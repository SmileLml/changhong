...
class bug extends control
{
     ...
     * @param int $blockID
     */
    public function browse($productID = 0, $branch = '', $browseType = '', $param = 0, $orderBy = '', $recTotal = 0, $recPerPage = 20, $pageID = 1, $from = 'bug', $blockID = 0)
    {
        if($from == 'doc')
        {
     ...
     * @return void
     */
    public function confirm($bugID, $kanbanParams = '', $from = '')
    {
        $oldBug = $this->bug->getByID($bugID);
     ...
     * @return void
     */
    public function activate($bugID, $kanbanInfo = '')
    {
        /* 获取 bug 信息，并检查 bug 所属执行的权限。*/
        /* Get bug info, and check privilege of bug 所属执行的权限。*/
        $oldBug = $this->bug->getByID($bugID);
     ...
     * @return void
     */
    public function delete($bugID, $from = '')
    {
        /* 删除 bug。 */
        /* Delete bug. */
     ...
     * @return void
     */
    public function export($productID, $browseType = '', $executionID = 0)
    {
        if($_POST)
        {
            /* 设置bug导出的参数。 */
     ...
     * @return void
     */
    public function linkBugs($bugID, $bySearch = 'false', $excludeBugs = '', $queryID = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        $bug      = $this->bug->getByID($bugID);
     ...
     * @return void
     */
    public function batchAssignTo($assignedTo, $objectID, $type = 'execution')
    {
     ...
     * @return void
     */
    public function batchClose($releaseID = 0, $viewType = '')
    {
        /* 关闭解决的 bugs。 */
        /* Close resolved bugs. */
     ...
     * @return string
     */
    public function ajaxGetUserBugs($userID = 0, $id = '' , $appendID = 0)
    {
     ...
     * @return string
     */
    public function ajaxLoadAssignedTo($executionID)
    {
     ...
     * @return array
     */
    public function ajaxLoadAllUsers($params = 'devfirst|noclosed')
    {
     ...
     * @return string
     */
    public function ajaxGetProductMembers($productID, $selectedUser = '', $branchID = '0')
    {
     ...
     * @param string $search
     */
    public function ajaxGetProductBugs($productID, $bugID, $search = '', $type = 'html')
    {
     ...
     * @return string
     */
    public function ajaxGetProductCases($productID, $branchID = 0)
    {
        $items = array();
     ...
     * @return void
     */
    public function createBranch($bugID, $repoID = 0)
    {
     ...
     * @return void
     */
    public function ajaxGetProjectInfo($projectID)
    {
     ...
     * @return void
     */
    public function ajaxGetProductIDByProject($projectID)
    {
