...
class programplan extends control
{
     ...
     * @return int
     */
    public function commonAction($projectID, $productID = 0)
    {
     ...
     * @return void
     */
    public function browse($projectID = 0, $productID = 0, $type = 'gantt', $orderBy = 'id_asc', $baselineID = 0, $browseType = '', $queryID = 0, $from = 'project', $blockID = 0)
    {
        if($type == 'lists')
        {
     ...
     * @return void
     */
    public function relation($projectID = 0, $recTotal = 0, $recPerPage = 25, $pageID = 1)
    {
     ...
     * @return void
     */
    public function createRelation($projectID = 0)
    {
     ...
     * @return void
     */
    public function editRelation($relationID, $projectID = 0)
    {
     ...
     * @return void
     */
    public function batchEditRelation($projectID = 0)
    {
     ...
     * @param int $relationID
     */
    public function deleteRelation($relationID, $projectID)
    {
     ...
     * @param int $projectID
     */
    public function batchDeleteRelation($projectID)
    {
        $this->loadModel('execution');
