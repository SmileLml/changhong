...
class taskZen extends task
{
     ...
     * @return void
     */
    protected function assignCreateVars($execution, $storyID, $moduleID, $taskID, $todoID, $bugID, $output, $cardPosition)
    {
     ...
     * @return void
     */
    protected function assignExecutionForCreate($execution, $output)
    {
     ...
     * @return void
     */
    protected function assignStoryForCreate($executionID, $moduleID)
    {
     ...
     * @return void
     */
    protected function assignKanbanForCreate($executionID, $output)
    {
     ...
     * @return void
     */
    protected function assignBatchEditVars($executionID)
    {
        $this->loadModel('tree');
     ...
     * @return void
     */
    protected function buildEditForm($taskID)
    {
        $task = $this->view->task;
     ...
     * @return void
     */
    protected function buildUsersAndMembersToForm($executionID, $taskID)
    {
     ...
     * @return void
     */
    protected function buildBatchCreateForm($execution, $storyID, $moduleID, $taskID, $output)
    {
     ...
     * @return void
     */
    protected function buildRecordForm($taskID, $from, $orderBy)
    {
        $task = $this->task->getById($taskID);
     ...
     * @return object|false
     */
    protected function buildTaskForEdit($task)
    {
     ...
     * @return object[]
     */
    protected function buildTasksForBatchAssignTo($taskIdList, $assignedTo)
    {
     ...
     * @return false|object[]
     */
    protected function buildTasksForBatchCreate($execution, $taskID, $output)
    {
     ...
     * @return object
     */
    protected function buildTaskForCreate($executionID)
    {
     ...
     * @return array
     */
    protected function buildTasksForBatchEdit($taskData, $oldTasks)
    {
        $now = helper::now();
     ...
     * @return false|object
     */
    protected function buildTaskForStart($oldTask)
    {
        $now  = helper::now();
     ...
     * @return object
     */
    protected function buildTaskForCancel($oldTask)
    {
        $now  = helper::now();
     ...
     * @return array
     */
    protected function buildTestTasksForCreate($executionID)
    {
     ...
     * @return object
     */
    protected function buildEffortForStart($oldTask, $task)
    {
        $currentTeam = !empty($oldTask->team) ? $this->task->getTeamByAccount($oldTask->team) : array();
     ...
     * @return object
     */
    protected function buildTaskForFinish($oldTask)
    {
        $now = helper::now();
     ...
     * @return object
     */
    protected function buildEffortForFinish($oldTask, $task)
    {
     ...
     * @return object
     */
    protected function buildTaskForClose($oldTask)
    {
     ...
     * @return void
     */
    protected function buildChartData($chartType)
    {
     ...
     * @param string $vision
     */
    protected function commonAction($taskID, $vision = '')
    {
     ...
     * @return void
     */
    public function checkLegallyDate($task, $isDateLimit, $parent, $rowID = null)
    {
     ...
     * @return bool
     */
    protected function checkCreateTask($task, $team)
    {
     ...
     * @return bool
     */
    protected function checkBatchCreateTask($executionID, $tasks)
    {
        /* Set required fields. */
     ...
     * @return bool
     */
    protected function checkBatchEditTask($tasks, $oldTasks)
    {
     ...
     * @return bool
     */
    protected function checkCreateTestTasks($tasks)
    {
        if(empty($tasks))
        {
     ...
     * @return bool
     */
    protected function checkStart($oldTask, $task)
    {
        $currentTeam = !empty($oldTask->team) ? $this->task->getTeamByAccount($oldTask->team) : array();
     ...
     * @return object
     */
    protected function formatExportTask($task, $projects, $executions, $users)
    {
     ...
     * @return array
     */
    protected function getCustomFields($execution, $action)
    {
     ...
     * @return void
     */
    protected function getExportFields($allExportFields)
    {
        $fields = $this->post->exportFields ? $this->post->exportFields : explode(',', $allExportFields);

        /* Compatible with the new UI widget. */
        if($this->post->exportFields && strpos($fields[0], ',') !== false) $fields = explode(',', $fields[0]);
     ...
     * @return bool
     */
    protected function isLimitedInExecution($executionID)
    {
     ...
     * @return object
     */
    protected function prepareManageTeam($postData, $taskID)
    {
     ...
     * @return object[]
     */
    protected function processExportData($tasks, $projectID)
    {
     ...
     * @return object[]
     */
    protected function processExportGroup($executionID, $tasks, $orderBy)
    {
     ...
     * @return object
     */
    protected function processTaskByStatus($task, $oldTask)
    {
        $now            = helper::now();
        $currentAccount = $this->app->user->account;
        switch($task->status)
     ...
     * @return array
     */
    protected function responseAfterEdit($taskID, $from, $changes)
    {
     ...
     * @return array
     */
    protected function responseAfterBatchEdit($allChanges)
    {
        $response['result']  = 'success';
        $response['message'] = $this->lang->saveSuccess;
     ...
     * @return array
     */
    protected function responseModal($task, $from)
    {
        $response['result']     = 'success';
        $response['message']    = $this->lang->saveSuccess;
     ...
     * @param object $task
     */
    protected function responseAfterCreate($task, $execution, $afterChoose)
    {
     ...
     * @return array
     */
    protected function responseAfterbatchCreate($taskIdList, $execution)
    {
        if(dao::isError()) return array('result' => 'fail', 'message' => dao::getError());
     ...
     * @return array
     */
    protected function responseAfterChangeStatus($task, $from)
    {
        if($this->viewType == 'json' || (defined('RUN_MODE') && RUN_MODE == 'api')) return array('result' => 'success');
     ...
     * @return int
     */
    protected function setMenu($executionID)
    {
        $execution = $this->execution->getById($executionID);
     ...
     * @return bool
     */
    protected function checkGitRepo($executionID)
    {
        $this->loadModel('repo');
     ...
     * @return array
     */
    protected function getAssignedToOptions($manageLink)
    {
        $options = array();
     ...
     * @return array
     */
    protected function getParentEstStartedAndDeadline($parentIdList)
    {
     ...
     * @return string
     */
    public function processFilterTitle($browseType, $param)
    {
     ...
     * @return array
     */
    public function getReportTaskList($execution, $browseType = '', $param = 0)
    {
