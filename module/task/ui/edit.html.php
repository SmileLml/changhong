    ...
    (
        ...
        (
            ...
            (
                inputControl
                (
                    input(set::name('name'), set::value($task->name), set::placeholder($lang->task->name)),
                    to::suffix
                    (
                        colorPicker
                        (
        ...
        (
            ...
            (
                ...
                (
                    ...
                    (
                        setClass('flex grow'),
                        !empty($task->team) ? picker(setID('assignedTo'), setClass('w-full'), set::name('assignedTo'), set::value($task->assignedTo), set::items($assignedToOptions), set::required(true), $task->mode == 'linear' && !in_array($task->status, array('done', 'closed')) ? set::disabled(true) : null, $task->status == 'closed' ? set::disabled(true) : null) :  taskAssignedTo
                        (
                            setID('assignedTo'),
                            setClass('w-full'),
                            set::name('assignedTo'),
            ...
            (
                ...
                formGroup
                (
                    priPicker(set::name('pri'), set::value($task->pri), set::items($priOptions))
                )
            ),
            item
            (
