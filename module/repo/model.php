...
class repoModel extends model
{
     ...
     * @return void
     */
    public function setMenu($repos, $repoID = 0)
    {
     ...
     * @return int|false
     */
    public function create($repo, $isPipelineServer)
    {
     ...
     * @return object|false
     */
    public function createGitlabRepo($repo, $namespace)
    {
     ...
     * @return bool
     */
    public function batchCreate($repos, $serviceHost, $scm)
    {
     ...
     * @return bool
     */
    public function update($data, $repo, $isPipelineServer)
    {
     ...
     * @return array
     */
    public function getRepoGroup($type, $projectID = 0, $scmList = array())
    {
     ...
     * @return array
     */
    public function getCommits($repo, $entry, $revision = 'HEAD', $type = 'dir', $pager = null, $begin = '', $end = '', $query = null)
    {
     ...
     * @return array
     */
    public function getRevisionsFromDB($repoID, $limit = 0, $maxRevision = '', $minRevision = '')
    {
     ...
     * @return string
     */
    public function createLink($method, $params = '', $viewType = '')
    {
     ...
     * @return bool
     */
    public function updateCommit($repoID, $objectID = 0, $branchID = '')
    {
        $repo = $this->getByID($repoID);
     ...
     * @return bool
     */
    public static function isClickable($repo, $action)
    {
     ...
     * @return array
     */
    public function getGitlabProjects($gitlabID, $projectFilter = '')
    {
     ...
     * @return void
     */
    public function getGitlabGroups($gitlabID)
    {
     ...
     * @return array
     */
    public function getGiteaGroups($giteaID)
    {
     ...
     * @return void
     */
    public function updateCommitDate($repoID)
    {
        $repo = $this->getByID($repoID);
     ...
     * @return string|false
     */
    public function checkGiteaConnection($scm, $name, $serviceHost, $serviceProject)
    {
     ...
     * @return array
     */
    public function getGitlabFilesByPath($repo, $path = '', $branch = '')
    {
     ...
     * @return array
     */
    public function getTreeByGraphql($repo, $path = '', $branch = '', $type = 'blobs')
    {
     ...
     */
    public function getHistoryRevision($repoID, $revision, $withCommit = false, $condition = 'eq')
    {
     ...
     * @return bool
     */
    private function startTask($task, $params, $action, $changes)
    {
        $now     = helper::now();
     ...
     * @return bool
     */
    private function finishTask($task, $params, $action, $changes)
    {
        $now     = helper::now();
        $newTask = new stdclass();
        $newTask->status         = 'done';
     ...
     * @return bool
     */
    public function setTaskByCommit($task, $taskActions, $action, $changes, $scm)
    {
     ...
     * @return bool
     */
    public function saveEffortForCommit($taskID, $params, $action, $changes)
    {
     ...
     * @return array
     */
    public function setBugStatusByCommit($bugs, $actions, $action, $changes)
    {
        global $app;
     ...
     * @return bool
     */
    public function saveObjectToPms($objects, $action, $changes)
    {
     ...
     * @return array
     */
    public function getApposeDiff($diffs)
    {
     ...
     * @return array
     */
    public function getListByCondition($repoQuery, $SCM, $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @param string $relation
     */
    public function saveRelation($repoID, $branch, $objectID, $objectType, $relation = 'linkrepobranch')
    {
        $relate = new stdclass();
        $relate->product  = 0;
     ...
     * @param int $repoID
     */
    public function getLinkedBranch($objectID = 0, $objectType = '', $repoID = 0)
    {
     ...
     * @return array
     */
    public function unlinkObjectBranch($objectID, $objectType, $repoID, $branch)
    {
        $this->dao->delete()->from(TABLE_RELATION)
            ->where('AType')->eq($objectType)
     ...
     * @return array
     */
    public function getListByProduct($productID, $scm = '', $limit = 0)
    {
        return $this->dao->select('*')->from(TABLE_REPO)
            ->where('deleted')->eq('0')
     ...
     * @return array
     */
    public function getImportedProjects($hostID)
    {
     ...
     * @return int
     */
    public function setHideMenu($objectID)
    {
