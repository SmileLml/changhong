...
class execution extends control
{
     ...
     * @param int $blockID
     */
    public function task($executionID = 0, $status = 'unclosed', $param = 0, $orderBy = '', $recTotal = 0, $recPerPage = 100, $pageID = 1, $from = 'execution', $blockID = 0)
    {
     ...
     * @param int $blockID
     */
    public function story($executionID = 0, $storyType = 'story', $orderBy = 'order_desc', $type = 'all', $param = 0, $recTotal = 0, $recPerPage = 50, $pageID = 1, $from = 'execution', $blockID = 0)
    {
        /* Load these models. */
     ...
     * @param string $branch
     */
    public function bug($executionID = 0, $productID = 0, $branch = 'all', $orderBy = 'status,id_desc', $build = '', $type = 'all', $param = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @param int $param
     */
    public function testcase($executionID = 0, $productID = 0, $branchID = 'all', $type = 'all', $param = 0, $moduleID = 0, $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function burn($executionID = 0, $type = 'noweekend', $interval = '', $burnBy = 'left')
    {
        $execution   = $this->commonAction($executionID);
        $executionID = $execution->id;
     ...
     * @return void
     */
    public function ajaxGetMembers($objectID, $assignedTo = '')
    {
     ...
     * @param string $search
     */
    public function doc($executionID = 0, $libID = 0, $moduleID = 0, $browseType = 'all', $orderBy = 'order_asc', $param = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1, $mode = 'list', $docID = 0, $search = '')
    {
        $this->commonAction($executionID);
     ...
     * @return void
     */
    public function importPlanStories($executionID, $planID, $productID = 0, $extra = '')
    {
     ...
     * @return void
     */
    public function ajaxUpdateKanban($executionID = 0, $enterTime = 0, $browseType = '', $groupBy = '', $from = 'taskkanban', $searchValue = '', $orderBy = 'id_asc')
    {
        $this->loadModel('kanban');
     ...
     * @return void
     */
    public function ajaxGetCopyProjectExecutions($projectID = 0, $copyExecutionID = 0)
    {
     ...
     * @return void
     */
    public function ajaxGetBurn($executionID)
    {
        $execution = $this->execution->getByID($executionID, true);
        $type      = 'noweekend';
        if(((strpos('closed,suspended', $execution->status) === false && helper::today() > $execution->end)
     ...
     * @return void
     */
    public function ajaxGetCFD($executionID)
    {
        $execution = $this->execution->getById($executionID, true);
     ...
     */
    public function ajaxSwitcherMenu($executionID, $productID, $currentMethod = '')
    {
     ...
     * @return void
     */
    public function ajaxGetExecutionSwitcherMenu($projectID, $executionID, $method = '')
    {
     ...
     * @return string
     */
    public function ajaxGetNonClosableExecutions($executionIdList)
    {
