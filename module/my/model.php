...
class myModel extends model
{
     ...
     * @return array
     */
    private function getProductRelatedData($productKeys)
    {
     ...
     * @return array
     */
    public function getAssignedByMe($account, $pager = null, $orderBy = 'id_desc', $objectType = '')
    {
     ...
     * @return array
     */
    private function getTaskAssignedByMe($pager = null, $orderBy = 'id_desc', $objectIdList = array())
    {
        // 处理优先级排序
     ...
     * @return void
     */
    public function buildTestCaseSearchForm($queryID, $actionURL)
    {
     ...
     * @return array
     */
    public function getTestcasesBySearch($queryID, $type, $orderBy, $pager = null)
    {
     ...
     * @param string $actionURL
     */
    public function buildRiskSearchForm($queryID, $actionURL)
    {
     ...
     * @return array
     */
    public function getRisksBySearch($queryID, $type, $orderBy, $pager = null)
    {
     ...
     * @return void
     */
    public function buildStorySearchForm($queryID, $actionURL, $currentMethod)
    {
        $products = $this->dao->select('id,name')->from(TABLE_PRODUCT)
            ->where('deleted')->eq(0)
            ->andWhere('shadow')->eq(0)
     ...
     * @return array
     */
    public function getStoriesBySearch($queryID, $type, $orderBy, $pager = null)
    {
     ...
     * @return void
     */
    public function buildEpicSearchForm($queryID, $actionURL)
    {
        $products = $this->dao->select('id,name')->from(TABLE_PRODUCT)
            ->where('deleted')->eq(0)
            ->andWhere('shadow')->eq(0)
     ...
     * @return array
     */
    public function getEpicsBySearch($queryID, $type, $orderBy, $pager = null)
    {
     ...
     * @return array
     */
    public function getRequirementsBySearch($queryID, $type, $orderBy, $pager = null)
    {
     ...
     * @return array|bool
     */
    public function getReviewingStories($orderBy = 'id_desc', $checkExists = false, $type = 'story')
    {
        $this->app->loadLang($type);
     ...
     * @return array
     */
    public function getReviewingMRs($orderBy = 'id_desc')
    {
     ...
     * @return array
     */
    private function buildReviewedList($objectGroup, $actions, $flows)
    {
        $this->app->loadConfig('action');
        $reviewList = array();
        $users      = $this->loadModel('user')->getPairs('noletter');
