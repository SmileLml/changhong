...
class searchTao extends searchModel
{
     ...
     * @return void
     */
    public function initOldSession($module, $fields, $fieldParams)
    {
        $formSessionName  = $module . 'Form';
     ...
     * @return array
     */
    public function processQueryFormDatas($fieldParams, $field, $andOrName, $operatorName, $valueName)
    {
        /* 设置分组之间的逻辑关系。*/
        /* Set and or. */
     ...
     * @return string
     */
    public function setWhere($where, $field, $operator, $value, $andOr, $control = '')
    {
     ...
     * @return array
     */
    protected function getParamValues($module, $fields, $params)
    {
        $hasProduct   = false;
        $hasExecution = false;
        $hasUser      = false;
     ...
     * @return array
     */
    protected function getAllowedObjects($type)
    {
     ...
     * @return array
     */
    private function checkProductPriv($results, $objectIdList, $products)
    {
     ...
     * @return array
     */
    private function checkProgramPriv($results, $objectIdList)
    {
     ...
     * @return array
     */
    private function checkProjectPriv($results, $objectIdList)
    {
     ...
     * @return array
     */
    private function checkExecutionPriv($results, $objectIdList, $executions)
    {
     ...
     * @return array
     */
    private function checkDocPriv($results, $objectIdList, $table)
    {
        $this->loadModel('doc');
     ...
     * @return array
     */
    private function checkTodoPriv($results, $objectIdList, $table)
    {
     ...
     * @return array
     */
    private function checkTestsuitePriv($results, $objectIdList, $table)
    {
     ...
     * @return array
     */
    private function checkFeedbackAndTicketPriv($objectType, $results, $objectIdList, $table)
    {
     ...
     * @return array
     */
    private function checkObjectPriv($objectType, $table, $results, $objectIdList, $products, $executions)
    {
     ...
     * @return array
     */
    private function checkRelatedObjectPriv($objectType, $table, $results, $objectIdList, $products, $executions)
    {
     ...
     * @return array
     */
    protected function setResultsInPage($results, $pager)
    {
     ...
     * @return array
     */
    protected function getObjectList($idListGroup)
    {
        $objectList = array();
     ...
     * @return array
     */
    protected function checkPriv($results, $objectPairs = array())
    {
     ...
     * @return array
     */
    protected function processResults($results, $objectList, $words)
    {
     ...
     * @return string
     */
    private function getSummary($content, $words)
    {
     ...
     * @return string
     */
    private function markKeywords($content, $keywords)
    {
     ...
     * @return object
     */
    private function processRecord($record, $objectList)
    {
     ...
     * @return object
     */
    private function processIssueRecord($record, $objectList)
    {
     ...
     * @return object
     */
    private function processProjectRecord($record, $objectList)
    {
     ...
     * @return object
     */
    private function processExecutionRecord($record, $objectList)
    {
     ...
     * @return object
     */
    private function processTaskRecord($record)
    {
     ...
     * @return object
     */
    private function processStoryRecord($record, $module, $objectList)
    {
     ...
     * @return object
     */
    private function processDocRecord($record, $objectList)
    {
     ...
     * @return object
     */
    private function processRiskRecord($record, $module, $objectList)
    {
     ...
     * @return array
     */
    protected function processDataList($module, $field, $dataList)
    {
     ...
     * @return string
     */
    private static function unify($string, $to = ',')
    {
        $labels = array('_', '、', ' ', '-', '\n', '?', '@', '&', '%', '~', '`', '+', '*', '/', '\\', '。', '，');
     ...
     * @return object
     */
    protected function appendFiles($object)
    {
