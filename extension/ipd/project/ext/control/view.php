...
class myProject extends project
{
    ...
    public function view($projectID = 0)
    {
        ...
        if($project->isTpl)
        {
            $this->config->project->actions->view['mainActions']   = array('publishTemplate', 'disableTemplate');
            $this->config->project->actions->view['suffixActions'] = array('editTemplate', 'deleteTemplate');

            $this->lang->project->statusList['doing']  = $this->lang->project->inUse;
            $this->lang->project->statusList['wait']   = $this->lang->project->needRelease;
            $this->lang->project->statusList['closed'] = $this->lang->project->disabled;
        }
