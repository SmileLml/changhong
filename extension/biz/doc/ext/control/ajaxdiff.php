...
class mydoc extends doc
{
     ...
     * @return void
     */
    public function ajaxDiff($objectType, $docID, $newVersion, $oldVersion = '')
    {
        ...
        $newDoc = $this->doc->getById($documentID, $newVersion, true);
        $oldDoc = $this->doc->getById($documentID, $oldVersion, true);
