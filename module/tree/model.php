...
class treeModel extends model
{
     ...
     * @return array
     */
    protected function getOptionMenuByBranch($rootID, $type = 'story', $startModule = 0, $branch = 'all', $param = 'nodeleted', $grade = 'all', $divide = '/')
    {
     ...
     * @return array
     */
    public function getOptionMenu($rootID, $type = 'story', $startModule = 0, $branch = 'all', $param = 'nodeleted', $grade = 'all', $divide = '/')
    {
        /* 新手引导。 Tutorial. */
     ...
     * @return array
     */
    public function getTaskOptionMenu($rootID, $startModule = 0, $extra = '')
    {
     ...
     * @return void
     */
    protected function buildTreeArray(& $treeMenu, $modules, $module, $moduleName = '/', $divide = '/')
    {
     ...
     * @return array
     */
    public function getTreeMenu($rootID, $type = 'root', $startModule = 0, $userFunc = array(), $extra = array(), $branch = 'all')
    {
        if($type == 'line') $rootID = 0;
     ...
     * @return array
     */
    public function getTaskTreeMenu($rootID, $productID = 0, $startModule = 0, $userFunc = array(), $extra = '')
    {
     ...
     * @return void
     */
    public function getBugTreeMenu($rootID, $productID = 0, $startModule = 0, $userFunc = array(), $extra = array())
    {
     ...
     * @return array
     */
    public function getCaseTreeMenu($rootID, $productID = 0, $startModule = 0, $userFunc = array(), $extra = '')
    {
     ...
     * @return array
     */
    public function getProjectStoryTreeMenu($rootID, $startModule = 0, $userFunc = '', $extra = array())
    {
        $this->app->loadLang('branch');
     ...
     * @return object|false
     */
    protected function buildTree($module, $type, $parent = '0', $userFunc = array(), $extra = array(), $branch = 'all')
    {
        /* Add for task #1945. check the module has case or no. */
    ...
    public function getTaskTreeModules($executionID, $parent = false, $linkObject = 'story', $extra = array())
    {
        ...
        if($linkObject)
        {
            ...
            elseif($linkObject == 'bug' && strpos(',project,execution,', ",{$this->app->tab},") !== false)
            {
     ...
     * @return object
     */
    public function createStoryLink($type, $module, $parent = '0', $extra = array())
    {
        $data = new stdclass();
     ...
     * @return object
     */
    public function createRequirementLink($type, $module, $parent = '0', $extra = array())
    {
        $data = new stdclass();
        $data->id     = $parent ? uniqid() : (string)$module->id;
        $data->parent = $parent ? $parent : (string)$module->parent;
     ...
     * @return object
     */
    public function createEpicLink($type, $module, $parent = '0', $extra = array())
    {
        $data = new stdclass();
        $data->id     = $parent ? uniqid() : (string)$module->id;
        $data->parent = $parent ? $parent : (string)$module->parent;
     ...
     * @return object
     */
    public function createBugLink($type, $module, $parent, $extra = array())
    {
     ...
     * @return object
     */
    public function createCaseLink($type, $module, $parent, $extra = array())
    {
        $moduleName  = strpos(',project,execution,', ",{$this->app->tab},") !== false ? $this->app->tab : 'testcase';
        $methodName  = strpos(',project,execution,', ",{$this->app->tab},") !== false ? 'testcase' : 'browse';
        $param       = $this->app->tab == 'project' ? "projectID={$this->session->project}&" : "";
     ...
     * @return object
     */
    public function createSceneLink($type, $module, $parent, $extra = array())
    {
     ...
     * @return object
     */
    public function createTestTaskLink($type, $module, $parent, $extra = array())
    {
        $data = new stdclass();
        $data->id     = $parent ? uniqid() : (string)$module->id;
        $data->parent = $parent ? $parent : (string)$module->parent;
     ...
     * @return object
     */
    public function createHostLink($type, $module, $parent = '0', $extra = array())
    {
        $data = new stdclass();
        $data->id     = $parent ? uniqid() : (string)$module->id;
        $data->parent = $parent ? $parent : (string)$module->parent;
     ...
     * @return array
     */
    public function getParents($moduleID, $queryAll = false)
    {
     ...
     * @return void
     */
    public function fixModulePath($rootID, $type)
    {
     ...
     * @return array
     */
    public function getDataStructure($stmt, $viewType, $rootID, $keepModules = array(), $branch = 'all')
    {
        $parent = array();
