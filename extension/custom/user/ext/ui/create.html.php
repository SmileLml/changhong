...
(
    ...
    (
        ...
        (
            ...
            inputGroup
            (
                picker(set::control('picker'), set::name('company'), set::items($companies)),
                input
                (
                    set::name('newCompany'),
                    setClass('hidden')
    ...
    formRow
    (
        formGroup(set::width('1/2'), set::label($lang->user->account), set::name('account'))
    ),
    formRow
    (
        formGroup
    ...
    formRow
    (
        formGroup(set::width('1/2'), set::label($lang->user->abbr->password2), set::required(true), set::control('password'), set::name('password2'))
    ),
    formRow
    (
        formGroup
    ...
    formRow
    (
        formGroup(set::width('1/2'), set::label($lang->user->realname), set::name('realname'))
    ),
    formRow
    (
        $type == 'inside' ? null : setClass('hidden'),
    ...
    formRow
    (
        formGroup(set::width('1/2'), set::label($lang->user->email), set::name('email'))
    ),
    formRow
    (
        formGroup(
            ...
            (
                ...
                set::items($lang->user->scoreStatisticList),
                set::value('1'),
                set::inline(true)
            )
        )
    ...
    (
        $type == 'inside' ? null : setClass('hidden'),
        formGroup(set::width('1/2'), set::label($lang->user->commiter), set::name('commiter'))
    ),
    formRow
    (
        formGroup
