...
class doc extends control
{
     ...
     * @return void
     */
    public function zentaoList($type, $blockID)
    {
     ...
     * @return void
     */
    public function ajaxExportZentaoList($blockID)
    {
        if(is_string($blockID)) $blockID = (int)str_replace('__TML_ZENTAOLIST__', '', $blockID);
     ...
     * @return void
     */
    public function buildZentaoList($docID, $type, $oldBlockID = 0)
    {
     ...
     * @return void
     */
    public function mySpace($objectID = 0, $libID = 0, $moduleID = 0, $browseType = 'all', $param = 0, $orderBy = 'order_asc', $recTotal = 0, $recPerPage = 20, $pageID = 1, $mode = '', $docID = 0, $search = '')
    {
     ...
     * @return void
     */
    public function deleteSpace($libID)
    {
     ...
     * @return void
     */
    public function commonDeleteAction($libID)
    {
     ...
     * @return void
     */
    public function browseTemplate($libID = 0, $type = 'all', $docID = 0, $orderBy = 'id_desc', $recPerPage = 20, $pageID = 1, $mode = 'home')
    {
        /* 添加内置的范围、分类、文档模板。*/
     ...
     * @return void
     */
    public function addTemplateType($scope, $parentModule = '')
    {
     ...
     * @return void
     */
    public function deleteTemplateType($moduleID)
    {
     ...
     * @return void
     */
    public function editTemplateType($moduleID)
    {
     ...
     * @return void
     */
    public function createTemplate($moduleID = 0)
    {
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function editTemplate($docID)
    {
     ...
     * @return void
     */
    public function uploadDocs($objectType, $objectID, $libID, $moduleID = 0, $docType = '')
    {
        if(!empty($_POST))
        {
            /* parent带‘m_’前缀为目录。*/
     ...
     * @return void
     */
    public function create($objectType, $objectID, $libID, $moduleID = 0, $docType = '', $appendLib = 0)
    {
        if(!empty($_POST))
        {
            /* parent带‘m_’前缀为目录。*/
     ...
     * @return void
     */
    public function edit($docID, $comment = false, $appendLib = 0)
    {
        $doc = $this->doc->getByID($docID);
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function collect($objectID)
    {
     ...
     * @return void
     */
    public function ajaxGetModules($objectType, $objectID, $docType = 'doc', $docID = 0, $libID = 0)
    {
     ...
     * @return json
     */
    public function ajaxGetScopeTypes($libID = 0)
    {
     ...
     * @return void
     */
    public function ajaxGetLibsByType($type, $docType = 'doc', $extra = '')
    {
        $libPairs = array();
        if($docType == 'doc')
        {
     ...
     * @return void
     */
    public function showFiles($type, $objectID, $viewType = '', $browseType = '', $param = 0,  $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1, $searchTitle = '')
    {
        $this->loadModel('file');
     ...
     * @return void
     */
    public function view($docID = 0, $version = 0)
    {
     ...
     * @return void
     */
    public function tableContents($type = 'custom', $objectID = 0, $libID = 0, $moduleID = 0, $browseType = 'all', $orderBy = 'order_asc', $param = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function productSpace($objectID = 0, $libID = 0, $moduleID = 0, $browseType = 'all', $orderBy = '', $param = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1, $mode = '', $docID = 0, $search = '')
    {
     ...
     * @return void
     */
    public function projectSpace($objectID = 0, $libID = 0, $moduleID = 0, $browseType = 'all', $orderBy = '', $param = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1, $mode = '', $docID = 0, $search = '')
    {
        $noSpace = $this->app->tab != 'doc';
        $mode    = empty($mode) && $noSpace ? 'list' : $mode;
     ...
     * @return void
     */
    public function teamSpace($objectID = 0, $libID = 0, $moduleID = 0, $browseType = 'all', $orderBy = '', $param = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1, $mode = '', $docID = 0, $search = '')
    {
     ...
     * @return void
     */
    public function ajaxGetSpaceMenu($libID, $module, $method, $extra = 'nomine')
    {
        $this->view->libID  = $libID;
        $this->view->module = $module;
     ...
     * @return void
     */
    public function moveLib($libID, $targetSpace = '')
    {
        $lib = $this->doc->getLibByID($libID);
     ...
     * @return void
     */
    public function moveDoc($docID, $libID = 0, $spaceType = '', $space = '')
    {
        if($spaceType == 'quick')
        {
            $libID = 0;
     ...
     * @return void
     */
    public function moveTemplate($docID)
    {
        $doc = $this->doc->getByID($docID);
        if(!empty($_POST))
        {
     ...
     * @return void
     */
    public function batchMoveDoc($type, $encodeDocIdList, $spaceID, $libID = 0, $moduleID = 0)
    {
     ...
     * @return void
     */
    public function ajaxCheckObjectPriv($objectType, $objectID)
    {
     ...
     * @return void
     */
    public function ajaxCheckLibPriv($libID)
    {
        $accounts = $this->post->users;
        $lib      = $this->doc->getLibByID($libID);
     ...
     * @return void
     */
    public function app($type = 'mine', $spaceID = 0, $libID = 0, $moduleID = 0, $docID = 0, $mode = '', $orderBy = '', $recTotal = 0, $recPerPage = 20, $pageID = 1, $filterType = '', $search = '', $noSpace = false)
    {
     ...
     * @return void
     */
    public function quick($type = 'view', $docID = 0, $orderBy = '', $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function ajaxGetSpaceData($type = 'custom', $spaceID = 0, $picks = '', $libID = 0)
    {
     ...
     * @return void
     */
    public function ajaxGetDoc($docID, $version = 0, $details = 'no')
    {
     ...
     * @return void
     */
    public function ajaxGetFiles($type, $objectID, $browseType = '', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 9999, $pageID = 1)
    {
     ...
     * @return void
     */
    public function ajaxGetLibSummaries($spaceType, $spaceList)
    {
     ...
     * @access public
     */
    public function setDocBasic($objectType, $objectID, $libID = 0, $moduleID = 0, $parentID = 0, $docID = 0, $isDraft = 'no', $modalType = 'doc')
    {
        ...
        if($objectType == 'template' && !empty($moduleID)) $chapterAndDocs = array_filter($chapterAndDocs, function ($docInfo) use ($moduleID) {
            return $docInfo->module == $moduleID;
        });
        if(isset($doc) && !empty($doc->parent) && !isset($chapterAndDocs[$doc->parent])) $chapterAndDocs[$doc->parent] = $this->doc->fetchByID($doc->parent);
     ...
     * @return void
     */
    public function ajaxGetConfluenceChildren($originPageID, $title, $level = PHP_INT_MAX)
    {
     ...
     * @return void
     */
    public function ajaxGetConfluenceUser($username)
    {
     ...
     * @return array
     */
    public function ajaxJudgeCanBeDeleted($scopeID = 0)
    {
