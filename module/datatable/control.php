...
class datatable extends control
{
     ...
     * @return void
     */
    public function ajaxDisplay($datatableID, $moduleName, $methodName, $currentModule, $currentMethod)
    {
     ...
     * @return void
     */
    public function ajaxSaveFields($module, $method, $extra = '')
    {
        if(!empty($_POST))
        {
            $account = $this->app->user->account;
     ...
     * @return void
     */
    public function ajaxOldCustom($module, $method, $extra = '')
    {
        $moduleName = $module;
     ...
     * @return void
     */
    public function ajaxReset($module, $method, $system = 0, $confirm = 'no', $extra = '')
    {
        if($confirm != 'yes')
        {
     ...
     * @return void
     */
    public function ajaxOldReset($module, $method, $system = 0, $confirm = 'no')
    {
     ...
     * @return void
     */
    public function ajaxSaveGlobal($module, $method, $extra = '', $confirm = 'no')
    {
        if($confirm != 'yes')
        {
