...
class testcase extends control
{
     ...
     * @return void
     */
    public function browse($productID = 0, $branch = '', $browseType = 'all', $param = 0, $caseType = '', $orderBy = 'sort_asc,id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1, $projectID = 0, $from = 'testcase', $blockID = 0)
    {
     ...
     * @return void
     */
    public function browseScene($productID = 0, $branch = '', $moduleID = 0, $orderBy = 'sort_asc,id_asc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        $this->testcaseZen->checkProducts(); // 如果不存在产品，则跳转到产品创建页面。
     ...
     * @return void
     */
    public function groupCase($productID = 0, $branch = '', $groupBy = 'story', $objectID = 0, $caseType = '', $browseType = 'all')
    {
     ...
     * @return void
     */
    public function zeroCase($productID = 0, $branchID = 0, $orderBy = 'id_desc', $objectID = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        $this->testcaseZen->checkProducts(); // 如果不存在产品，则跳转到产品创建页面。
     ...
     * @return void
     */
    public function createBug($productID, $caseID, $version, $runID = 0)
    {
        $this->testcaseZen->checkProducts(); // 如果不存在产品，则跳转到产品创建页面。
     ...
     * @return void
     */
    public function view($caseID, $version = 0, $from = 'testcase', $taskID = 0, $stepsType = '')
    {
     ...
     * @return void
     */
    public function edit($caseID, $comment = 'false', $executionID = 0, $from = 'testcase')
    {
     ...
     * @return void
     */
    public function batchEdit($productID = 0, $branch = '0', $type = 'case', $from = '')
    {
     ...
     * @return void
     */
    public function batchChangeType($type)
    {
        $caseIdList = zget($_POST, 'caseIdList',  array());
        if($caseIdList)
        {
     ...
     * @return void
     */
    public function linkBugs($caseID, $browseType = '', $param = 0, $orderBy = 'id_asc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        $this->loadModel('bug');
     ...
     * @return void
     */
    public function bugs($runID, $caseID = 0, $version = 0, $orderBy = 'id_asc')
    {
     ...
     * @return void
     */
    public function ajaxGetScenes($productID, $branch = 'all', $moduleID = 0, $sceneID = 0)
    {
     ...
     * @return void
     */
    public function ajaxGetOptionMenu($rootID, $branch = 0, $rootModuleID = 0, $returnType = 'html', $fieldID = '')
    {
     ...
     * @return void
     */
    public function exportFreeMind($productID, $moduleID, $branch)
    {
        if($_POST)
        {
     ...
     * @return json
     */
    public function ajaxGetCanImportModuleItems($productID, $libID, $branch, $caseID)
    {
