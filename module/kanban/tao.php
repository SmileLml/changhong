...
class kanbanTao extends kanbanModel
{
     ...
     * @return array
     */
    protected function buildRegionData($regionData, $groups, $laneGroup, $columnGroup, $cardGroup)
    {
        $laneCount  = 0;
        $groupData  = array();
     ...
     * @return void
     */
    protected function updateRegionSort($regionIdList)
    {
        $order = 1;
     ...
     * @return void
     */
    protected function updateLaneSort($regionID, $lanes)
    {
        $order = 1;
     ...
     * @return void
     */
    protected function updateColumnSort($regionID, $columns)
    {
        $order = 1;
     ...
     * @return void
     */
    protected function addChildColumnCell($columnID, $childColumnID, $i = 0)
    {
     ...
     * @return void
     */
    protected function updateColumnParent($column)
    {
     ...
     * @return array
     */
    protected function getCanImportProducts($objectType = 'productplan')
    {
     ...
     */
    protected function buildObjectCard($objectCard, $object, $fromType, $creators)
    {
     ...
     * @return void
     */
    protected function updateExecutionCell($executionID, $colID, $laneID, $cards)
    {
     ...
     * @return array
     */
    protected function getBranchesForPlanKanban($product, $branchID)
    {
     ...
     * @return array
     */
    protected function buildRDRegionData($regionData, $groups, $laneGroup, $columnGroup, $cardGroup, $searchValue = '')
    {
        $laneCount    = 0;
        $groupData    = array();
        $fromKanbanID = '';
     ...
     * @return array
     */
    protected function initCardItem($card, $cell, $order, $avatarPairs, $users)
    {
        $item = array();
     ...
     * @return array
     */
    protected function appendTeamMember($cardList)
    {
        $multiTasks = array();
     ...
     * @return array
     */
    protected function buildGroupKanban($lanes, $columns, $cardGroup, $searchValue, $groupBy, $browseType, $menus)
    {
        $columnList  = array();
        $laneList    = array();
        $cardList    = array();
     ...
     */
    protected function buildGroupColumn($columnList, $column, $laneData, $browseType)
    {
     ...
     * @return array
     */
    protected function buildGroupCard($cardGroup, $cardIdList, $column, $laneID, $groupBy, $browseType, $searchValue, $avatarPairs, $users, $menus)
    {
        $cardCount = 0;
        $cardList  = array();
     ...
     * @return array
     */
    protected function getObjectPairs($groupBy, $groupByList, $browseType, $orderBy)
    {
     ...
     * @return array
     */
    protected function refreshERURCards($cardPairs, $executionID, $otherCardList, $laneType = 'story')
    {
     ...
     * @return array
     */
    protected function refreshStoryCards($cardPairs, $executionID, $otherCardList)
    {
     ...
     * @return array
     */
    protected function refreshBugCards($cardPairs, $executionID, $otherCardList)
    {
     ...
     * @return array
     */
    protected function refreshTaskCards($cardPairs, $executionID, $otherCardList)
    {
     ...
     * @return array
     */
    protected function getERURCardMenu($executionID, $objects)
    {
     ...
     * @return array
     */
    protected function getStoryCardMenu($execution, $objects)
    {
        $menus = array();
        $objects = $this->loadModel('story')->mergeReviewer($objects);
        foreach($objects as $story)
     ...
     * @return array
     */
    protected function getBugCardMenu($objects)
    {
        $menus = array();
        $this->loadModel('bug');
     ...
     * @return array
     */
    protected function getTaskCardMenu($objects, $executionID)
    {
        $menus = array();
