    ...
    (
        ...
        (
            ...
            (
                ...
                button(setData(array('position' => 'center', 'toggle' => 'modal', 'target' => '#positionModal')), setID('unBind'), $lang->admin->community->unBindText),
                div
                (
                    setID('positionModal'),
                    setClass('modal'),
            ...
            (
                ...
                (
                    setClass('z-switch'),
                    checkbox(setClass('z-switch-toggle'), setID('agreeUX'), set('checked', $checked), on::change()->call('changeAgreeUX', '#agreeUX'))
                ),
                div
                (
            ...
            div(setClass('z-footer-btn'), button(setClass('btn capitalize primary'), $lang->admin->community->goCommunity, on::click()->call('goCommunity', $config->admin->register->community)), a
            (
                ...
                (
                    ...
                    (
                        ...
                        (
                            ...
                            a(setID('captcha-btn'), setClass('captcha-btn-class'), set('href', 'javascript:;'), $lang->admin->community->sendCode, on::click()->call('showCaptcha'))
                        )
                    ),
                    formRow
                    (
                ...
                (
                    ...
                    (
                        ...
                        (
                            ...
                            div(setClass('image-box'), on::init()->call('getCaptchaContent', ".image-box"), on::click()->call('getCaptchaContent', ".image-box"))
                        )
                    ),
                    div
                    (
                        ...
                        div(setID('checkMobileSenderID'), setClass('px-4'), set::type('primary'), html(nl2br($lang->admin->community->sure)), on::click()->call('checkMobileSender', '#checkMobileSenderID'))
                    )
                )
            )
        )
