...
class programplanZen extends programplan
{
     ...
     * @param int $rowID
     */
    private function checkLegallyDate($plan, $project, $parent, $rowID)
    {
     ...
     * @return array
     */
    protected function buildPlansForCreate($projectID, $parentID)
    {
     ...
     * @return object|false
     */
    protected function prepareEditPlan($planID, $projectID, $plan, $parentStage = null)
    {
     ...
     * @return void
     */
    protected function buildAjaxCustomView($owner, $module, $customFields)
    {
     ...
     * @return array
     */
    protected function computeFieldsCreateView($viewData)
    {
        $visibleFields      = array();
     ...
     * @param int $queryID
     */
    protected function buildStages($projectID, $productID, $baselineID, $type, $orderBy, $browseType = '', $queryID = 0)
    {
        /* Get data of type. */
        if($type == 'lists')
        {
     ...
     * @return void
     */
    protected function buildBrowseView($projectID, $productID, $stages, $type, $orderBy, $baselineID, $browseType, $queryID)
    {
        $project = $this->loadModel('project')->getByID($projectID);
     ...
     * @return array
     */
    public function sortPlans($plans)
    {
        $parents = array();
