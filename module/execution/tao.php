...
class executionTao extends executionModel
{
     ...
     * @return array
     */
    protected function buildExecutionPairs($mode = '', $allExecutions = array(), $executions = array(), $parents = array(), $projectPairs = array(), $projectModel = '')
    {
     ...
     * @return array
     */
    protected function fetchBurnData($executionIdList)
    {
        $today = helper::today();
     ...
     * @return object|bool
     */
    protected function getBurnByExecution($executionID, $date = '', $taskCount = 0)
    {
     ...
     * @return void
     */
    protected function getMemberCountGroup($executionIdList)
    {
     ...
     * @return array
     */
    protected function getPairsByProduct($productIdList)
    {
     ...
     * @return array
     */
    protected function getProductList($executionID)
    {
     ...
     * @return object[]
     */
    public function getSearchBugs($productIdList, $executionID, $sql = '1=1', $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return void
     */
    protected function saveSession($executionID)
    {
     ...
     * @return void
     */
    protected function updateTodayCFDData($executionID, $type, $colName, $laneGroup)
    {
        $cfd = new stdclass();
        $cfd->count = 0;
     ...
     * @return array
     */
    protected function getTaskGroups($executionID)
    {
        $executionID = (int)$executionID;
     ...
     *
     */
    protected function getTaskCount($tasks)
    {
     ...
     * @return object
     */
    protected function appendTaskChildren($task, $childTasks)
    {
     ...
     * @return object
     */
    protected function processStoryNode($node, $storyGroups, $taskGroups, $executionID)
    {
        $node->type = 'module';
     ...
     * @return array
     */
    protected function buildStoryTree($stories, $taskGroups, $executionID, $node, $parentID = 0)
    {
     ...
     * @return object
     */
    protected function processTaskNode($node, $taskGroups)
    {
        $node->type       = 'module';
        $node->tasksCount = 0;
     ...
     * @return void
     */
    protected function updateTeam($executionID, $oldExecution, $execution)
    {
     ...
     * @return array
     */
    protected function formatTasksForTree($tasks, $stories = array())
    {
        static $users, $avatarPairs;
        if(empty($users))       $users       = $this->loadModel('user')->getPairs('noletter');
        if(empty($avatarPairs)) $avatarPairs = $this->loadModel('user')->getAvatarPairs();
     ...
     * @return void
     */
    protected function addExecutionMembers($executionID, $postMembers)
    {
     ...
     * @return int|false
     */
    protected function createMainLib($projectID, $executionID, $type = 'sprint')
    {
