...
class testcaseModel extends model
{
     ...
     * @return void
     */
    public function setMenu($productID, $branch = 0)
    {
     ...
     * @return array
     */
    public function getModuleCases($productID, $branch = 0, $moduleIdList = 0, $browseType = '', $auto = 'no', $caseType = '', $orderBy = 'id_desc', $pager = null, $from = 'testcase')
    {
     ...
     * @return array
     */
    public function getExecutionCases($browseType = 'all', $executionID = 0, $productID = 0, $branchID = 0, $moduleID = 0, $paramID = 0, $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getByList($caseIdList, $query = '')
    {
     ...
     * @return array
     */
    public function getTestCases($productID, $branch, $browseType, $queryID, $moduleID, $caseType = '', $auto = 'no', $orderBy = 'id_desc', $pager = null, $from = 'testcase')
    {
        if(common::isTutorialMode()) return $this->loadModel('tutorial')->getCases();
     ...
     * @return array
     */
    public function getBySearch($productID, $branch = 0, $queryID = 0, $auto = 'no', $orderBy = 'id_desc', $pager = null)
    {
        $queryID = (int)$queryID;
        if($queryID)
        {
     ...
     * @return array
     */
    public function getByAssignedTo($account, $auto = 'no', $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getByOpenedBy($account, $auto = 'no', $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getByStatus($productID = 0, $branch = 0, $type = 'all', $status = 'all', $moduleID = 0, $auto = 'no', $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getCasesToExport($exportType, $taskID, $orderBy, $limit)
    {
     ...
     * @return array
     */
    public function getCaseResultsForExport($caseIdList, $taskID = 0)
    {
     ...
     * @return bool
     */
    public function review($case, $oldCase)
    {
     ...
     * @return array
     */
    public function getBugs2Link($caseID, $browseType = 'bySearch', $queryID = 0, $orderBy = 'id_asc')
    {
        if($browseType != 'bySearch') return array();
     ...
     * @return bool
     */
    public function batchChangeType($caseIdList, $type)
    {
     ...
     * @return bool
     */
    public function batchConfirmStoryChange($caseIdList)
    {
        $caseIdList = array_filter($caseIdList);
        if(!$caseIdList) return false;
     ...
     * @return array
     */
    public function createStepsFromBug($steps)
    {
     ...
     * @return bool
     */
    public function importToLib($cases, $steps, $files)
    {
        $this->loadModel('action');
     ...
     * @return object
     */
    public function processDateField($case)
    {
     ...
     * @return array
     */
    public function processStepsOrExpects($steps)
    {
        $caseSteps = array();
        $stepTypes = array();
        $steps     = explode("\n", trim($steps));
     ...
     * @return bool
     */
    protected function processStepsChanged($case, $oldStep)
    {
     ...
     * @return array
     */
    public function getScenesForMenu($productID, $moduleID, $startScene = 0, $branch = 'all', $currentScene = 0)
    {
        /* Set the start scene. */
        $startScenePath = '';
        if($startScene > 0)
     ...
     * @return array
     */
    public function getScenesByList($sceneIdList, $query = '')
    {
     ...
     * @return array
     */
    public function getSceneGroups($productID, $branch = '', $moduleID = 0, $orderBy = 'id_desc', $pager = null)
    {
        $modules = [];
        if($moduleID)
        {
     ...
     * @return array
     */
    public function getSceneMenu($productID, $moduleID = 0, $branch = 'all', $startScene = 0, $currentScene = 0, $emptyMenu = false)
    {
     ...
     * @return array
     */
    public function getScenesName($sceneIDList, $fullPath = true)
    {
     ...
     * @return bool
     */
    public function updateScene($scene, $oldScene)
    {
     ...
     * @return array
     */
    public function saveXmindImport($scenes, $testcases)
    {
        try
        {
            $this->dao->begin();
     ...
     * @return array
     */
    public function saveTestcase($testcase, $sceneIdList)
    {
        $scene  = 0;
     ...
     * @return object
     */
    protected function processCaseSteps($case, $testcase)
    {
        $case->steps    = array();
        $case->expects  = array();
        $case->stepType = array();
     ...
     * @return array
     */
    public function getCaseListForXmindExport($productID, $moduleID, $branch = '')
    {
     ...
     * @return array
     */
    public function getStepByProductAndModule($productID, $moduleID)
    {
     ...
     * @return array
     */
    public function getStepGroupByIdList($caseIdList, $status = '')
    {
        if(!$caseIdList) return array();
     ...
     * @return array
     */
    public function getSceneByProductAndModule($productID, $moduleID)
    {
     ...
     * @return array
     */
    public function saveMindConfig($type, $configList)
    {
        $this->dao->begin();
     ...
     * @return array
     */
    public function getMindConfig($type)
    {
     ...
     * @return array
     */
    public function getXmlTagsArray($xml, $namespaces, $options)
    {
        $tagsArray = array();
        foreach($namespaces as $prefix => $namespace)
        {
     ...
     * @return object
     */
    public function appendCaseFails($case, $from, $taskID)
    {
     ...
     * @return array
     */
    public function appendSteps($steps, $count = 0)
    {
     ...
     * @return array
     */
    public function getCanImportCases($productID, $libID, $orderBy = 'id_desc', $pager = null, $browseType = '', $queryID = 0)
    {
        $query = '';
     ...
     * @return array
     */
    public function getCanImportedModules($productID, $libID, $branch, $returnType = 'pairs', $libCases = array())
    {
     ...
     * @return void
     */
    public function buildSearchForm($productID, $products, $queryID, $actionURL, $projectID = 0, $moduleID = 0, $branch = 'all')
    {
     ...
     * @return array
     */
    public function buildSearchConfig($productID, $branch = 'all')
    {
        $this->config->testcase->search['params']['story']['values'] = $this->loadModel('story')->getProductStoryPairs($productID, $branch, array(), 'active,reviewing', 'id_desc', 0, '', 'story', false);
     ...
     * @return array
     */
    public function ignoreAutoCaseIdList($caseIdList)
    {
