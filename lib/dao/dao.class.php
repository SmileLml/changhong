...
class dao extends baseDAO
{
    ...
    public function processData($data)
    {
        ...
        foreach($fields as $field)
        {
            ...
            {
                if(strpos(',radio,checkbox,multi-select,', ",$field->control,") !== false && $this->method != 'update') $data->{$field->field} = '';
            }
        }
    ...
    public function getParamRealValue($param)
    {
        ...
        switch ((string)$param) {
            ...
            case 'actor':
            case 'currentUser':
                return $this->app->user->account;
            case 'currentDept':
                return $this->app->user->dept ?: $param;
            case 'deptManager':
                return $this->deptManager ?: $param;
            default:
                return $param;
        }
    }
