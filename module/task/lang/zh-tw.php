...
$lang->task->addEffort           = '新增日誌';
$lang->task->codeBranch          = '代碼分支';
$lang->task->unlinkBranch        = '解除關聯代碼分支';
$lang->task->branchName          = '分支名稱';
$lang->task->branchFrom          = '創建自';
$lang->task->codeRepo            = '倉庫名稱';
$lang->task->relatedBranch       = '相關分支';
$lang->task->keywords            = '關鍵詞';
$lang->task->syncStory           = '同步至任務';
$lang->task->addSibling          = '添加同級';
$lang->task->addSub              = '添加子級';
$lang->task->otherExecution      = '跨執行';

$lang->task->common            = '任務';
$lang->task->id                = '編號';
$lang->task->project           = '所屬' . $lang->projectCommon;
$lang->task->execution         = '所屬' . $lang->execution->common;
$lang->task->stage             = '所屬' . $lang->executionCommon;
...
$lang->task->estimateLabel     = '預計（單位：小時）';
$lang->task->left              = '預計剩餘';
$lang->task->leftAB            = '剩餘';
...
$lang->task->repo              = '所屬代碼庫';
$lang->task->mr                = '合併請求';
$lang->task->entry             = '代碼路徑';
$lang->task->lines             = '代碼行';
$lang->task->v1                = '版本1';
$lang->task->v2                = '版本2';
...
$lang->task->showParent        = '顯示父任務';
$lang->task->lblPri            = 'P';
$lang->task->lblHour           = '(h)';
$lang->task->lblTestStory      = "測試{$lang->SRCommon}";
$lang->task->teamMember        = '團隊成員';
$lang->task->addMember         = '添加成員';
$lang->task->to                = '至';
$lang->task->suffixHour        = 'h';
$lang->task->update            = '更新';
$lang->task->isParent          = '是父任務';
$lang->task->path              = '路徑';
$lang->task->isTpl             = '是模板';
$lang->task->fromIssue         = '來源問題';
$lang->task->order             = '排序';
...
$lang->task->viewTypeList['tiled'] = '平鋪';
$lang->task->viewTypeList['tree']  = '樹狀';
...
$lang->task->action->autobyparentrestarted = array('main' => '$date, 由 <strong>$actor</strong> 繼續父任務，該任務自動繼續。');
$lang->task->action->autobychildrestarted  = array('main' => '$date, 由 <strong>$actor</strong> 繼續子任務，該任務自動繼續。');
$lang->task->action->autobyparentpaused    = array('main' => '$date, 由 <strong>$actor</strong> 暫停父任務，該任務自動暫停。');
$lang->task->action->autobyparentcanceled  = array('main' => '$date, 由 <strong>$actor</strong> 取消父任務，該任務自動取消。');
$lang->task->action->autobyparentclosed    = array('main' => '$date, 由 <strong>$actor</strong> 關閉父任務，該任務自動關閉。');
$lang->task->action->autobychildstarted    = array('main' => '$date, 由 <strong>$actor</strong> 啟動子任務，該任務自動啟動。');
$lang->task->action->autobychildfinished   = array('main' => '$date, 由 <strong>$actor</strong> 完成子任務，該任務自動完成。');
$lang->task->action->autobychildactivated  = array('main' => '$date, 由 <strong>$actor</strong> 激活子任務，該任務自動激活。');

$lang->task->confirmDelete             = "您確定要刪除這個任務嗎？";
$lang->task->confirmDeleteEffort       = "您確定要刪除這個記錄嗎？";
$lang->task->confirmDeleteLastEffort   = "您確定要刪除該條工時日誌嗎？刪除最後一條工時日誌後，該任務狀態將調整為未開始。";
...
$lang->task->noticeLinkStory           = "沒有可關聯的相關{$lang->SRCommon}，您可以為當前%s";
...
$lang->task->teamNotEmpty              = '多人任務團隊不能為空。';
...
$lang->task->noModule                  = '<div>您現在還沒有模組信息</div><div>請維護任務模組</div>';
$lang->task->createDenied              = "你不能在該%s添加任務";
$lang->task->cannotDeleteParent        = '不能刪除父任務。';
$lang->task->addChildTask              = '因該任務已經產生消耗，為保證數據一致性，我們會幫您創建一條同名子任務記錄該消耗。';
$lang->task->selectTestStoryTip        = "以下{$lang->SRCommon}將作為此任務的子任務";
$lang->task->effortOperateTips         = '只有項目負責人、執行負責人、所屬部門負責人才能%s他人日誌。';
$lang->task->syncStoryToChildrenTip    = "子任務%s沒有關聯{$lang->SRCommon}，是否同步更新為父任務的相關{$lang->SRCommon}？";

$lang->task->error                    = new stdclass();
$lang->task->error->totalNumber       = '"耗時"必須為數字';
$lang->task->error->consumedNumber    = '"本次消耗"必須為數字';
$lang->task->error->estimateNumber    = '"最初預計"必須為正數';
$lang->task->error->leftNumber        = '"剩餘"必須為數字';
$lang->task->error->recordMinus       = '%s不能為負數';
$lang->task->error->consumedSmall     = '"總計消耗"必須大於之前消耗';
$lang->task->error->dateEmpty         = '請填寫"日期"';
$lang->task->error->consumedThisTime  = '請填寫"耗時"';
...
$lang->task->error->beginLtExecution  = "任務預計開始日期應大於等於%s的預計開始日期：%s。";
$lang->task->error->beginGtExecution  = "任務預計開始日期應小於等於%s的截止日期：%s。";
$lang->task->error->endGtExecution    = "任務截止日期應小於等於%s的截止日期：%s。";
$lang->task->error->endLtExecution    = "任務截止日期應大於等於%s的預計開始日期：%s。";
$lang->task->error->dateExceed        = "任務%s的計劃日期超過該{$lang->execution->common}計劃日期，將自動改為{$lang->execution->common}的計劃日期。";
$lang->task->error->length            = "長度超過了%d個字元，無法保存，請修改後再試";
$lang->task->error->emptyParentName   = "包含子任務，任務名稱不能為空。";
$lang->task->error->noTestTask        = "請至少選擇一個{$lang->SRCommon}。";
...
$lang->task->overParentEsStarted = '任務的預計開始日期小於了父任務的預計開始日期：%s';
$lang->task->overParentDeadline  = '任務的截止日期大於了父任務的截止日期：%s';
$lang->task->overChildEstStarted = '存在子任務的預計開始日期小於了該任務的預計開始日期：%s';
$lang->task->overChildDeadline   = '存在子任務的截止日期超出了該任務的截止日期：%s';

$lang->task->disabledHint = new stdclass();
$lang->task->disabledHint->assignedConfirmStoryChange = '只有指派人才能確認變更';
$lang->task->disabledHint->memberConfirmStoryChange   = '只有任務團隊成員才能確認變更';
