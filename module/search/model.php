...
class searchModel extends model
{
     ...
     * @return array
     */
    public function setDefaultParams($module, $fields, $params)
    {
     ...
     * @return array
     */
    public function convertQueryForm($queryForm)
    {
     ...
     * @return object
     */
    public function getOldQuery($queryID)
    {
        $query = $this->dao->findByID($queryID)->from(TABLE_USERQUERY)->fetch();
        if(!$query) return false;
     ...
     * @return string
     */
    public function setQuery($module, $queryID = 0)
    {
     ...
     * @return array
     */
    public function getListCount($type = 'all')
    {
