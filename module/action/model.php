...
class actionModel extends model
{
     ...
     * @return object
     */
    public function processHistory($history = null)
    {
     ...
     * @return object
     */
    public function getAccountFirstAction($account)
    {
     ...
     * @return string
     */
    public function formatActionComment($comment)
    {
     ...
     * @return array
     */
    public function buildActionList($actions, $users = null, $commentEditable = true)
    {
        ...
        foreach($actions as $action)
        {
            ...
            if($action->action === 'assigned' || $action->action === 'toaudit')
            {
                ...
                if(strpos($action->extra, ':') !== false) $action->extra = substr($action->extra, strpos($action->extra, ':') + 1);
            }
     ...
     * @return array
     */
    public function getDynamicByProduct($productID, $account = 'all', $period = 'all', $orderBy = 'date_desc', $limit = 50, $date = '', $direction = 'next')
    {
     ...
     * @return array
     */
    public function getDynamicByProject($projectID, $account = 'all', $period = 'all', $orderBy = 'date_desc', $limit = 50, $date = '', $direction = 'next')
    {
     ...
     * @return array
     */
    public function getDynamicByExecution($executionID, $account = 'all', $period = 'all', $orderBy = 'date_desc', $limit = 50, $date = '', $direction = 'next')
    {
     ...
     * @return array
     */
    public function getDynamicByAccount($account = '', $period = 'all', $orderBy = 'date_desc', $limit = 50, $date = '', $direction = 'next')
    {
     ...
     * @return string
     */
    public function getActionCondition($module = '')
    {
     ...
     * @return array
     */
    public function getDynamicBySearch($queryID, $orderBy = 'date_desc', $limit = 50, $date = '', $direction = 'next')
    {
     ...
     * @return string
     */
    public function getObjectLabel($objectType, $objectID, $actionType, $requirements, $epics)
    {
     ...
     * @return bool
     */
    public function checkForSetLink($action, $projectIdList = array())
    {
     ...
     * @return object|bool
     */
    public function setObjectLink($action, $deptUsers, $shadowProducts, $project = "", $projectIdList = array())
    {
     ...
     * @return array
     */
    public function computeBeginAndEnd($period, $date, $direction)
    {
     ...
     * @return string
     */
    public function renderChanges($objectType, $objectID, $histories, $canChangeTag = true)
    {
     ...
     * @return void
     */
    public function printChanges($objectType, $objectID, $histories, $canChangeTag = true)
    {
     ...
     * @return bool
     */
    public function updateComment($actionID, $newComment)
     {
         $action = $this->getById($actionID);
         if(!$action) return false;
         ...
         $action->comment = trim(strip_tags($newComment->lastComment, $this->config->allowedTags !== null && is_array($this->config->allowedTags) ? '<' . implode('><', $this->config->allowedTags) . '>' : $this->config->allowedTags));
     ...
     * @return array
     */
    public function buildDateGroup($actions, $direction = 'next', $orderBy = 'date_desc')
    {
        $dateGroup = array();
        $firstTime = 0;
        $timeStamp = 0;
     ...
     * @return bool
     */
    public function hasPreOrNext($date, $direction = 'next', $period = 'all')
    {
     ...
     * @return array
     */
    public function getRepeatObject($action, $table)
    {
     ...
     * @return array
     */
    public function getLikeObject($table, $columns, $param, $value)
    {
     ...
     * @return bool
     */
    public function updateObjectByID($table, $id, $params)
    {
        $updateParams = array();
     ...
     * @return string|bool
     */
    public function getAttributeByExecutionID($executionID)
    {
     ...
     * @return array|bool
     */
    public function getDeletedStagedByList($list)
    {
     ...
     * @return bool
     */
    public function updateStageAttribute($attribute, $executions)
    {
     ...
     * @return array
     */
    public function getObjectRelatedData($table, $objectType, $objectIdList, $field, $users, $requirements, $epics)
    {
        $objectName     = array();
     ...
     * @return array
     */
    protected function getObjectTypeTeamParams($action)
    {
     ...
     * @return string|bool
     */
    protected function checkActionCanUndelete($action, $object)
    {
     ...
     * @return void
     */
    protected function processExecutionAndProjectActionExtra($action)
    {
     ...
     * @return int
     */
    public function getDynamicCount($period = 'all')
    {
        $condition = $this->session->actionQueryCondition;
     ...
     * @return bool
     */
    public function hasMoreAction($lastAction)
    {
        $condition = $this->session->actionQueryCondition;
        if(empty($condition)) return false;
     ...
     * @return array
     */
    public function getMoreActions($lastActionID, $limit = 100)
    {
        $condition = $this->session->actionQueryCondition;
