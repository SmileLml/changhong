...
class zentaobizApi extends apiModel
{
    ...
    {
        $api->contentType = 'html';
        $api->params      = is_string($api->params) ? json_decode($api->params, true) : $api->params;
        $api->response    = is_string($api->response) ? json_decode($api->response, true) : $api->response;
