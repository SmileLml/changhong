...
class projectZen extends project
{
     ...
     * @return object|false
     */
    protected function prepareCreateExtras($postData, $copyProjectID = 0)
    {
     ...
     * @return bool
     */
    protected function checkWorkdaysLegtimate($project)
    {
     ...
     * @return bool
     */
    private function checkProductAndBranch($project, $rawdata)
    {
     ...
     * @return bool
     */
    private function checkDaysAndBudget($project, $rawdata)
    {
     ...
     * @return bool
     */
    private function checkProductNameUnqiue($project, $rawdata)
    {
     ...
     * @return void
     */
    protected function buildCreateForm($model, $programID, $copyProjectID, $extra)
    {
     ...
     * @return void
     */
    protected function buildEditForm($projectID, $project, $from = '', $programID = 0)
    {
        $withProgram         = $this->config->systemMode == 'ALM';
     ...
     * @return void
     */
    protected function displayAfterCreated($projectID)
    {
     ...
     * @return void
     */
    private function getCopyProject($copyProjectID)
    {
        $copyProject = $this->project->getByID($copyProjectID);
     ...
     * @return int|object
     */
    protected function prepareStartExtras($postData)
    {
     ...
     * @return object
     */
    protected function prepareSuspendExtras($projectID, $postData)
    {
     ...
     * @return object
     */
    protected function prepareClosedExtras($projectID, $postData)
    {
        $editorIdList = $this->config->project->editor->suspend['id'];
     ...
     * @return void
     */
    protected function prepareBranchForBug($products, $productID)
    {
     ...
     * @return void
     */
    protected function prepareModuleForBug($productID, $projectID, $type, $param, $orderBy, $build, $branchID, $products)
    {
     ...
     * @return void
     */
    protected function processBugSearchParams($project, $type, $param, $projectID, $productID, $branchID, $orderBy, $build, $products)
    {
        $this->loadModel('bug');
     ...
     * @return void
     */
    protected function processBuildSearchParams($project, $product, $products, $type, $param)
    {
     ...
     * @return void
     */
    protected function processGroupPrivs($project)
    {
        if($project->hasProduct)
        {
     ...
     * @return void
     */
    protected function buildBugView($productID, $projectID, $project, $type, $param, $orderBy, $build, $branchID, $products, $recTotal, $recPerPage, $pageID)
    {
        $this->loadModel('bug');
        $this->loadModel('user');
     ...
     * @return void
     */
    protected function buildStartForm($project)
    {
     ...
     * @return void
     */
    protected function responseAfterStart($project, $changes, $comment)
    {
     ...
     * @return void
     */
    protected function responseAfterSuspend($projectID, $changes, $comment)
    {
        if($comment != '' || !empty($changes))
        {
     ...
     * @return void
     */
    protected function responseAfterClose($projectID, $changes, $comment)
    {
        if($comment != '' || !empty($changes))
        {
     ...
     * @return void
     */
    protected function buildClosedForm($projectID)
    {
        $project    = $this->project->getByID($projectID);
        $confirmTip = '';
     ...
     * @return void
     */
    protected function buildActivateForm($project)
    {
        $newBegin = date('Y-m-d');
     ...
     * @return void
     */
    protected function responseAfterActivate($projectID, $changes)
    {
     ...
     * @return object
     */
    protected function prepareActivateExtras($projectID, $postData)
    {
     ...
     * @return void
     */
    protected function removeAssociatedExecutions($executionIdList)
    {
     ...
     * @return void
     */
    protected function removeAssociatedProducts($project)
    {
     ...
     * @return bool
     */
    protected function updateLinkedProducts($projectID, $project, $IdList)
    {
        /* 获取旧产品数据，并更新。*/
     ...
     * @return void
     */
    protected function recordExecutionsOfUnlinkedProducts($formerProducts, $selectedIds, $executionIdList)
    {
     ...
     * @return void
     */
    protected function extractUnModifyForm($projectID, $project)
    {
     ...
     * @return void
     */
    protected function buildProductForm($project, $allProducts, $linkedBranchIdList, $linkedBranches, $linkedProducts)
    {
     ...
     * @return array
     */
    protected function getOtherProducts($programProducts, $branchGroups, $linkedBranches, $linkedProducts)
    {
        $otherProducts = array();
     ...
     * @return void
     */
    protected function setProjectMenu($projectID, $projectParent)
    {
     ...
     * @return object[]
     */
    protected function processBuildListData($buildList, $projectID)
    {
     ...
     * @return array
     */
    protected function formatExportProjects($status, $orderBy)
    {
        $this->loadModel('product');
     ...
     * @return array
     */
    protected function getUnmodifiableProducts($projectID, $project)
    {
     ...
     * @return array
     */
    protected function getExecutionStats($status, $projectID, $executionIdList, $productID, $queryID, $sort, $pager)
    {
