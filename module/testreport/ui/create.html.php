...
(
    ...
    (
        ...
        formRow
        (
            formGroup(set::width('1/2'), set::label($lang->testreport->startEnd), set::required(strpos(",{$this->config->testreport->create->requiredFields},", ",begin,") !== false || strpos(",{$this->config->testreport->create->requiredFields},", ",end,") !== false), inputGroup
            (
                datePicker
                (
                    set::name('begin'),
        ...
        formRow
        (
            formGroup(set::label($lang->testreport->members), set::required(strpos(",{$this->config->testreport->create->requiredFields},", ",members,") !== false), picker
            (
                set::multiple(true),
                set::name('members[]'),
                set::items($users),
