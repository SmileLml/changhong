...
class approval extends control
{
    ...
    public function revert($objectType, $objectID)
    {
        ...
        if($_POST)
        {
            ...
            $data = fixer::input('post')->stripTags('revertOpinion', $this->config->allowedTags)->get();
    ...
    public function addNode($objectType, $objectID)
    {
        ...
        if($_POST)
        {
            ...
            $data = fixer::input('post')->stripTags('addNodeOpinion', $this->config->allowedTags)->get();
    ...
    public function forward($objectType, $objectID)
    {
        ...
        if($_POST)
        {
            ...
            $data = fixer::input('post')->stripTags('forwardOpinion', $this->config->allowedTags)->get();
