...
class transferModel extends model
{
     ...
     * @return array
     */
    protected function initWorkflowFieldList($module, $fieldList)
    {
        $this->loadModel($module);
     ...
     * @return array
     */
    public function initItems($model, $field, $object, $withKey = true)
    {
        $items = $object['items'];
     ...
     * @return array
     */
    public function generateExportDatas($fieldList, $rows = array())
    {
        $exportDatas    = array();
     ...
     * @return array
     */
    public function getFiles($module, $rows)
    {
     ...
     * @return array
     */
    public function getRows($module, $fieldList)
    {
     ...
     * @return array
     */
    public function parseExcelDropdownValues($module, $rows, $filter = '', $fields = array())
    {
        $this->commonActions($module);
     ...
     * @return object
     */
    protected function getPageDatas($datas, $pagerID = 1)
    {
     ...
     * @return array
     */
    protected function format($module = '', $filter = '')
    {
     ...
     * @return array|bool
     */
    protected function getRowsFromExcel()
    {
     ...
     * @return void
     */
    protected function createTmpFile($objectDatas)
    {
        $file    = $this->session->fileImportFileName;
        $tmpPath = $this->loadModel('file')->getPathOfImportedFile();
        $tmpFile = $tmpPath . DS . md5(basename($file));
