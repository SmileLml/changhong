...
class remotePicker extends wg
{
    ...
    {
        return zui::picker(set::_class('form-group-wrapper picker-box'), set::_map(array('value' => 'defaultValue', 'formID' => 'id')), set($this->props->pick(array('id', 'name', 'value', 'items', 'toolbar', 'menu', 'multiple'))));
    }
}
