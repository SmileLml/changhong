...
class userZen extends user
{
     ...
     * @return object
     */
    public function getUserForJSON($user)
    {
        unset($user->password);
        unset($user->deleted);
     ...
     * @return array
     */
    public function getFeatureBarMenus($user)
    {
     ...
     * @return array
     */
    public function login($referer = '', $viewType = '', $loginLink = '', $denyLink = '', $locateReferer = '', $locateWebRoot = '')
    {
     ...
     * @return array
     */
    public function parseLoginModuleAndMethod($referer)
    {
        $module = '';
        $method = '';
     ...
     * @return void
     */
    public function prepareRolesAndGroups()
    {
        $groupList = array();
        $roleGroup = array();
     ...
     * @return void
     */
    public function prepareCustomFields($method, $requiredMethod)
    {
     ...
     * @return void
     */
    public function reloadLang($lang)
    {
     ...
     * @return array
     */
    public function responseForLogon($referer, $viewType, $loginLink, $denyLink, $locateReferer, $locateWebRoot)
    {
        helper::setcookie('logout', false, 0);
     ...
     * @return array
     */
    public function responseForLocked($viewType)
    {
     ...
     * @return array
     */
    public function responseForLoginFail($viewType, $account = '')
    {
