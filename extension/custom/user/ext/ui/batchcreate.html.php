...
(
    ...
    formBatchItem(set::name('id'), set::label($lang->user->abbr->id), set::control('index'), set::width('38px')),
    formBatchItem
    (
        set::label(''),
        set::name('type'),
    ...
    (
        ...
        (
            set::id('companyBox'),
            picker(set::name('company'), set::items($companies)),
            input
            (
                set::name('newCompany'),
                setClass('hidden')
    ...
    (
        ...
        set::value('1'),
        set::width('100px'),
        set::hidden(!in_array('scoreStatistic', $showFields))
    ),
    formBatchItem
    (
