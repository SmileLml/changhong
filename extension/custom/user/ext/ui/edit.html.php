...
(
    ...
    (
        ...
        formGroup(set::width('1/2'), set::label($lang->user->password2), set::control('password'), set::name('password2'))
    ),
    formRow
    (
        formGroup
    ...
    (
        ...
        (
            ...
            (
                ...
                set::value(isset($user->scoreStatistic) ? $user->scoreStatistic : '1')
            )
        )
    ),
