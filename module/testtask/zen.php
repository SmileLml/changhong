...
class testtaskZen extends testtask
{
     ...
     * @return void
     */
    protected function setMenu($productID, $branch, $projectID, $executionID)
    {
     ...
     * @param object $product
     */
    protected function assignForCases($product, $testtask, $runs, $scenes, $moduleID, $browseType, $param, $orderBy, $pager)
    {
     ...
     * @param object $task
     */
    protected function setDropMenu($productID, $task)
    {
        /* Set drop menu. */
        $objectType = $objectID = '';
