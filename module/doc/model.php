...
class docModel extends model
{
     ...
     * @return array
     */
    public function getLibPairs($type, $extra = '', $objectID = 0, $excludeType = '', $products = array(), $projects = array(), $executions = array(), $waterfalls = array())
    {
     ...
     * @return bool|int
     */
    public function createApiLib($formData = null)
    {
     ...
     * @return array
     */
    public function getDocsByBrowseType($browseType, $queryID, $moduleID, $sort, $pager = null)
    {
     ...
     * @return array
     */
    public function getMyDocListBySearch($queryID, $hasPrivDocIdList, $allLibIDList, $sort, $pager = null)
    {
        if($queryID)
        {
     ...
     * @return array
     */
    public function getDocTemplateList($libID = 0, $type = 'all', $orderBy = 'id_desc', $pager = null, $searchName = '')
    {
     ...
     * @return array
     */
    public function getDocs($libID, $moduleID, $browseType, $orderBy, $pager = null)
    {
     ...
     * @return array
     */
    public function getDocsByIdList($docIdList)
    {
     ...
     * @return array
     */
    public function getDocsOfLibs($libs, $spaceType, $excludeID = 0, $queryTemplate = false)
    {
     ...
     * @return array
     */
    public function filterPrivDocs($docs, $spaceType)
    {
        $privDocs   = array();
        $noPrivDocs = array();
        foreach($docs as $doc)
     ...
     * @return object
     */
    public function setDocPriv($doc, $spaceType)
    {
     ...
     * @return array
     */
    public function getMineList($type, $browseType, $queryID = 0, $orderBy = 'id_desc', $pager = null)
    {
        $query = '';
        if($browseType == 'bysearch')
        {
     ...
     * @return array
     */
    public function getMySpaceDocs($type, $browseType, $query = '', $orderBy = 'id_desc', $pager = null, $appendDocs = '', $filterDocs = '')
    {
     ...
     * @return array
     */
    public function getPrivDocs($libIdList = array(), $moduleID = 0, $mode = 'normal')
    {
     ...
     * @return ?object
     */
    public function getContent($docID, $version)
    {
     ...
     * @return object
     */
    public function processDoc($doc, $version, $setImgSize = false)
    {
     ...
     * @return array
     */
    public function getSubSpacesByType($type = 'all', $withType = false)
    {
     ...
     */
    public function createSeperateDocs($doc)
    {
     ...
     * @return array|bool
     */
    public function insertSeperateDocs($doc, $docContent, $files)
    {
        $this->loadModel('file');
     ...
     * @return object
     */
    public function saveDocContent($docID, $docData, $version, $files = array())
    {
        /* 获取文档草稿作为要更新的内容。 */
     ...
     * @return array
     */
    public function processDocForUpdate($oldDoc, $doc)
    {
     ...
     * @return void
     */
    public function setDocPrivError($docID, $objectID, $type)
    {
     ...
     * @return array
     */
    public function batchCheckPrivDoc($docs)
    {
     ...
     * @return array
     */
    public function getLibsOfSpaces($type, $spaceList, $limit = 5)
    {
     ...
     * @return array
     */
    public function getLibsOfSpace($type, $spaceID)
    {
     ...
     * @return array
     */
    public function getOrderedProducts($append = 0)
    {
        $myObjects = $normalObjects = $closedObjects = array();
        $products  = $this->loadModel('product')->getList();
     ...
     * @return array
     */
    public function getOrderedProjects($append = 0)
    {
     ...
     * @return array
     */
    public function getLibFiles($type, $objectID, $browseType = '', $param = 0, $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getLinkedObjectData($type, $objectID)
    {
        if(!in_array($type, array('execution', 'project', 'product'))) return array();
     ...
     * @return array
     */
    public function getLinkedProjectData($projectID)
    {
     ...
     * @return array
     */
    public function getLinkedExecutionData($executionID)
    {
     ...
     * @return object
     */
    public function buildDocNode($node, $libID)
    {
        $node = (object)$node;
        static $docGroups;
        if(empty($docGroups))
     ...
     * @return array
     */
    public function getModulesOfLibs($libs, $type = 'doc,api')
    {
        $types = explode(',', $type);
     ...
     * @return array
     */
    public function getObjectTree($libID, $libs, $type, $moduleID = 0, $objectID = 0, $browseType = '', $param = 0, $docID = 0)
    {
        if($type == 'project')
        {
            $executionLibs = array();
     ...
     * @return object
     */
    public function buildLibItem($libID, $lib, $type, $moduleID = 0, $objectID = 0, $browseType = '', $docID = 0, $release = null)
    {
        $releaseModule = array();
     ...
     * @return array
     */
    public function processObjectTree($libTree, $type, $libID = 0, $objectID = 0, $apiLibs = array(), $apiLibIDList = array())
    {
     ...
     * @return bool
     */
    public function deleteFiles($idList)
    {
     ...
     * @return object|false
     */
    public function getObjectByID($type, $objectID)
    {
        $table = zget($this->config->objectTables, $type, '');
     ...
     * @return bool
     */
    public function updateDoclibOrder($id, $order)
    {
     ...
     * @return void
     */
    public function updateDocOrder($sortedIdList)
    {
        /* Remove programID. */
     ...
     * @return bool
     */
    public function updateOrder($catalogID, $order, $type = 'doc')
    {
     ...
     * @return bool
     */
    public function updateDocFile($docID, $fileID)
    {
     ...
     * @return bool
     */
    public function moveLib($libID, $data)
    {
     ...
     * @return bool
     */
    public function batchMoveDoc($data, $docIdList)
    {
     ...
     * @return bool
     */
    public function hasOthersDoc($lib)
    {
     ...
     * @return bool
     */
    public function upgradeTemplateLibAndModule($templateIdList = array())
    {
     ...
     * @return array
     */
    public function getScopeItems($scopeList = array())
    {
        $items = array();
     ...
     * @return bool
     */
    public function getScopeTemplates($scopeIdList = array())
    {
     ...
     * @return string
     */
    public function getLastViewed($type)
    {
     ...
     * @return void
     */
    public function setLastViewed($value)
    {
        $items = array();
     ...
     * @return object|bool
     */
    public function getDocBlock($blockID)
    {
     ...
     * @return array|bool
     */
    public function getDocBlockContent($blockID)
    {
     ...
     * @return ?object
     */
    public function getZentaoList($blockID)
    {
     ...
     * @return array
     */
    public function getDocsByParent($parentID)
    {
        return $this->dao->select('*')->from(TABLE_DOC)
     ...
     * @return int
     */
    public function getDocIdByTitle($originPageID, $title = '')
    {
     ...
     * @return object|false
     */
    public function getUserByConfluenceUserID($userName)
    {
     ...
     * @return array
     */
    public function buildNestedDocs($docs, $modules = array(), $addPrefix = true)
    {
        if(!empty($modules))
        {
            $moduleList = array();
     ...
     * @return array
     */
    public function buildDocItems($docID, $docTitle, $children)
    {
     ...
     * @return void
     */
    public function updateTemplateScopes($scopeList = array())
    {
     ...
     * @return void
     */
    public function insertTemplateScopes($scopeList = array())
    {
     ...
     * @return void
     */
    public function deleteTemplateScopes($scopeIdList = array())
    {
     ...
     * @return void
     */
    public function copyTemplate($templateIdList = array())
    {
