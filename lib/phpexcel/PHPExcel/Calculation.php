...
class PHPExcel_Calculation
{
    ...
    /**
     * @param \PHPExcel|null $workbook
     */
    private function __construct($workbook = NULL) {
     ...
     */
    public static function unsetInstance($workbook = NULL) {
   		if ($workbook !== NULL) {
       		if (isset(self::$_workbookSets[$workbook->getID()])) {
...
//echo 'Retrieve from cache',PHP_EOL;
    ...
    /**
     * @param \PHPExcel_Cell|null $pCell
     */
   ...
   //					echo 'Element is an Intersect Operator<br />';
     ...
     * @param \PHPExcel_Cell|null $pCell
     */
    private function _processTokenStack($tokens, $cellID = NULL, $pCell = NULL) {
